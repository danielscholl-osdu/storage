...
{{- define "storage.minReplicasSpot" -}}
{{- $tier := include "storage.getTier" . -}}
...
{{- define "storage.maxReplicasSpot" -}}
{{- $tier := include "storage.getTier" . -}}
...
{{- define "storage.replicasStandard" -}}
{{- $tier := include "storage.getTier" . -}}
